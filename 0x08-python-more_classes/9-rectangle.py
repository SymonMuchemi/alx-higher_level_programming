...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Raises:
            TypeError: if rect_1 is not a Rectangle instance
            TypeError: if rect_2 is not a Rectangle instance

        Returns:
            rect_1 or rect_2: the bigger rectangle
        """
    ...
    def square(cls, size=0):
        """create a rectangle with height and width being equal

        Args:
            size (int, optional): the length. Defaults to 0.
